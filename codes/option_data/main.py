...
class FOC:
    ...
    def get_session(self):
        ...
        try:
            ...
            session.get(get_src_home_url(self.asset_type), headers= {"User-Agent": self.User_Agent})
        except Exception:
            pass
    ...
    def get_options_chain_price(self,tickersymbol:str,expiration_date:str,option_type:OptionType=OptionType.CALL):
        ...
        url = get_options_price_url(tickersymbol,expiration_date,option_type,self.asset_type)
        headers = {
    ...
    def get_options_data(self,contract_symbol:str):
        ...
        url = get_options_contract_url(tickersymbol,contract_symbol,self.asset_type)
